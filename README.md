...
- [QOwnNotes](https://www.qownnotes.org/) - Plain-text file markdown note-taking with Nextcloud / ownCloud integration. [Source Code](https://github.com/pbek/QOwnNotes)) `GPL-2.0` `C++`
